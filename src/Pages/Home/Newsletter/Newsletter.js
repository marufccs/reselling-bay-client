...
const Newsletter = () => {
  ...
  <div className="hero-content text-center">
    <div className="max-w-md">
      ...
      <p className="py-6">Every week we send newsletters about what's going on into the book world, all kind of updates and even some bookish knowledges! If you don't want to miss those, subscribe right now!</p>
      <form >
      <input className='mr-2 py-3 rounded' type="email" name="email" placeholder='Type your email here'/>
      <button className="btn bg-accent text-white">Join Now</button>
      </form>
    </div>
  </div>
</div>
