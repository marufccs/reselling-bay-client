...
const AddProductShortStories = () => {
    ...
    const handleAddProductScienceFiction = data => {
        ...
        const product = {
            ...
            console.log(product);
            fetch(`https://used-products-resale-market-server-eight.vercel.app/category/637e7e300122d590fe2ebd85`, {
                method: 'POST',
                headers: {
    ...
    return (
        <div>
         ...
         <input type="text" value="Short Stories" disabled  placeholder="Product Name" className="input sm:w-3/4 lg:w-1/2 input-bordered" />
...
export default AddProductShortStories;